...
const UNHEALTHY_SENSITIVE: Record<ProfileType, Rule> = {
  ...
  kid:     { emoji: '⏱️', message: 'Limit outdoor play to 30 mins. Avoid noon.',      detail: "Pollution peaks at midday. Keep outdoor activity under 30 minutes — preferably morning or after 5pm. Watch for coughing or eye irritation." },
...
const UNHEALTHY: Record<ProfileType, Rule> = {
  ...
  runner:  { emoji: '🏋️', message: 'Postpone outdoor run. Try indoors.',             detail: 'Running outdoors in Unhealthy AQI dramatically increases pollution intake. Move your workout inside — treadmill, cycling, or yoga. Resume when AQI drops below 150.' },
  asthma:  { emoji: '⚕️', message: 'Stay indoors. PM2.5 can trigger symptoms.',       detail: 'PM2.5 at this level is a known asthma trigger. Staying indoors with windows closed is strongly recommended. If you must go out, wear an N95 mask.' },
};
